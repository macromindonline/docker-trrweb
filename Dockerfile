...
RUN apt-get update && apt-get install xvfb wkhtmltopdf cups php-net-socket -y && apt-get -y autoremove && apt-get clean && rm -rf /var/lib/apt/lists/* && mkdir -p /var/www/html/public
